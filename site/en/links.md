...
* [OpenStreetMap Wiki: Adresses](https://wiki.openstreetmap.org/wiki/Addresses)
* [Georeferenced Addresses of the Surveying Office (LGB) of the state of Brandenburg (Germany) – Information (in German) and download](https://geobasis-bb.de/lgb/de/geodaten/liegenschaftskataster/georeferenzierte-adresse/)
...
* [qa.poole.ch](https://qa.poole.ch/) – QA layer showing buildings without house numbers. Switch to the layer *no address*.
